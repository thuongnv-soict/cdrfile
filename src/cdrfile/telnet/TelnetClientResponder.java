 ...
 ***/
public class TelnetClientResponder implements Runnable
{
    InputStream _is;
    OutputStream _os;
     ...
     ***/
    public TelnetClientResponder(InputStream is, OutputStream os, String inputs[], String outputs[], long timeout)
    {
        _is = is;
        _os = os;
        _timeout = timeout;
    ...
    public static void main(String args[]){
       try{
          // TelnetTestResponder server = new TelnetTestResponder(23);
           //server.run();
       }catch(Exception de){
           de.printStackTrace();
       }
